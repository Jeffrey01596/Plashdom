...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.developerWebsite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Utils.openCustomTab(AboutActivity.this, Constants.mainDevWebsite, R.color.colorMainDevAccent);
            }
        });

        binding.githubString.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Utils.openCustomTab(AboutActivity.this, Constants.githubString, R.color.colorGithubBackground);
            }
        });

        binding.libraries.setOnClickListener(new View.OnClickListener() {
